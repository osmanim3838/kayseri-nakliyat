        ...
        <section className="bg-slate-900 py-16 text-white relative overflow-hidden mb-12">
          ...
          <div className="relative z-10 mx-auto max-w-5xl px-5 text-center">
            ...
            <h1 className="text-3xl font-black tracking-tight sm:text-5xl lg:text-6xl mb-6">
              ...
              <span className="text-amber-500 text-2xl sm:text-4xl lg:text-5xl">Dikmen'in Lider Taşıma Firması</span>
            </h1>
            <p className="mx-auto max-w-2xl text-slate-300 text-sm sm:text-base leading-relaxed">
              Ankara'nın kalbi Dikmen'dan, Dikmen'in yüksek rakımlı tepelerine kadar; eşyalarınızı sadece bir adresten diğerine değil, güvenle geleceğe taşıyoruz. Modern araç filomuz ve kurumsal altyapımızla hizmetinizdeyiz.
            </p>
          </div>
        </section>
        ...
        <div className="mx-auto max-w-6xl px-5 sm:px-8 space-y-16">
          ...
          <section className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center bg-white rounded-3xl p-6 sm:p-10 shadow-xl shadow-slate-200/50 border border-slate-100">
            <div className="order-2 lg:order-1 space-y-5">
              ...
              <h2 className="text-2xl sm:text-3xl font-black text-slate-900 tracking-tight">
                Dikmen Evden Eve Nakliyat: <br/> Profesyonellik ve Asansörlü Çözümler
              </h2>
              <p className="text-slate-600 leading-relaxed">
                Ankara'nın en yoğun ve prestijli ilçesi Dikmen'da taşınmak, doğru planlama gerektirir. Arıcıoğlu Nakliyat Dikmen şubesi olarak, yüksek katlı binalarda ve dar sokaklarda operasyon sürecini kusursuz yönetiyoruz. 
              </p>
              <p className="text-slate-600 leading-relaxed">
            ...
            <div className="order-1 lg:order-2 overflow-hidden rounded-2xl shadow-lg border border-slate-100">
              ...
              <img src="/dikmen-hakkimizda-10.jpg" alt="Dikmen Evden Eve Nakliyat - Asansörlü Taşımacılık Arıcıoğlu" className="w-full h-auto object-cover hover:scale-105 transition-transform duration-700" />
            </div>
          </section>
          ...
          <section className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center bg-white rounded-3xl p-6 sm:p-10 shadow-xl shadow-slate-200/50 border border-slate-100">
            <div className="overflow-hidden rounded-2xl shadow-lg border border-slate-100">
              ...
              <img src="/dikmen-hakkimizda-9.jpg" alt="Dikmen Evden Eve Nakliyat Şubesi Arıcıoğlu Nakliyat" className="w-full h-auto object-cover hover:scale-105 transition-transform duration-700" />
            </div>
          ...
          <section className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="bg-slate-900 p-8 rounded-3xl relative overflow-hidden group">
              ...
              <p className="text-slate-300 text-sm leading-relaxed">
                Müşterilerimizin taşınma stresini sıfıra indirmek; Ankara, Dikmen başta olmak üzere tüm Türkiye'ye eşya güvenliğini ve zamanında teslimatı garanti eden yenilikçi lojistik çözümleri sunmaktır.
              </p>
            </div>
          ...
          <section className="text-center pb-10">
            ...
            <p className="text-slate-600 mb-8 max-w-2xl mx-auto">
              Dikmen bölgesinde ücretsiz ekspertiz hizmetimizden yararlanmak ve size özel fiyat teklifi almak için hemen bizimle iletişime geçin.
            </p>
