    ...
    <div className="min-h-screen bg-slate-50 font-sans">
      ...
      <section className="relative overflow-hidden bg-slate-950 pb-20 pt-32 sm:pt-40">
        <div className="absolute inset-0 z-0 opacity-40">
          <img src="/resim.jpg" alt="Arka Plan" className="h-full w-full object-cover" />
      ...
      <section className="mx-auto max-w-7xl px-5 py-20 sm:px-8">
        <div className="mx-auto max-w-4xl space-y-16 text-slate-600 sm:text-lg sm:leading-relaxed">
          ...
          <motion.div variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once: true }} className="overflow-hidden rounded-3xl shadow-2xl">
            <img src="/resim3.jpg" alt="Asansörlü Taşıma Aracı" className="h-full w-full object-cover transition-transform duration-700 hover:scale-105" />
          </motion.div>
          ...
          <motion.div variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once: true }} className="overflow-hidden rounded-3xl shadow-2xl">
            <img src="/resim4.jpg" alt="Güvenli Depolama ve Paketleme" className="h-full w-full object-cover transition-transform duration-700 hover:scale-105" />
          </motion.div>
          ...
          <motion.div variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once: true }} className="overflow-hidden rounded-3xl shadow-2xl">
            <img src="/resim1.jpg" alt="Arıcıoğlu Nakliyat Araç Filosu" className="h-full w-full object-cover transition-transform duration-700 hover:scale-105" />
          </motion.div>
